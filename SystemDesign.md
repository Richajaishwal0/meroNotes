...
|-----------|----------|---------------|------------|--------------|
| **Month 1** | **Week 1** | **0%** - **[□□□□□□□□□] Week 1 – Computer Science Basics** | - OS Concepts (Processes, Threads, Memory Management) <br> - Networking Basics (TCP/IP, HTTP, DNS) <br> - Data Structures (Arrays, Linked Lists, Trees) <br> - Algorithms (Big O Notation, Sorting, Searching) | [ ] |
